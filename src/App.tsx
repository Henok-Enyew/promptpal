    ...
    <div className="relative min-h-screen">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
        ...
        <div className="hidden md:flex items-center gap-8 transition duration-500">
          <a href="#marketplace" className="text-white hover:text-slate-300 transition">
            Marketplace
          </a>
          <a href="#studio" className="text-white hover:text-slate-300 transition">
            Prompt Studio
          </a>
          <a href="#docs" className="text-white hover:text-slate-300 transition">
            Docs
          </a>
          <a href="#pricing" className="text-white hover:text-slate-300 transition">
            Pricing
          </a>
        </div>
